...
def btnEqualsInput():
    ...
    sumup=str(eval(text_Input.get()))
    text_Input.set(sumup)
    operator=""

cal = Tk()
cal.title('Python_Calculator')
operator=''
...
op=Button(cal,padx=16,pady=16,bd=8,fg="black",font=('arial',20,'bold'), 
    text="(", bg="powder blue",command=lambda : btnClick("(")).grid(row=1,column=4)
#=====================Row 2=======================================
...
cl=Button(cal,padx=16,pady=16,bd=8,fg="black",font=('arial',20,'bold'), 
    text=")", bg="powder blue",command=lambda : btnClick(")")).grid(row=2,column=4)
#=====================Row 3=======================================
...
btnClear=Button(cal,padx=16,pady=16,bd=8,fg="black",font=('arial',20,'bold'),  
    text="C", bg="powder blue",command= btnClearDisplay).grid(row=3,column=4)
#=====================Row 4=======================================
...
Delete=Button(cal,padx=16,pady=16,bd=8,fg="black",font=('arial',20,'bold'), 
    text="D", bg="powder blue",command=btnDeleteDisplay).grid(row=4,column=4)
#=====================Row 4=======================================
Footer=Label(cal,padx=16,pady=16,bd=8,fg="black",font=('arial',20,'bold'), 
    text="By Mr. Mara, study at ANT").grid(row=5,columnspan=5)
cal.mainloop()